	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="/main/index.do"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
			</li>
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="login.html">로그인</a> <a
							class="collapse-item" href="login.html">로그아웃</a> <a
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown no-arrow"><a
						...
						aria-expanded="false"> <span
							class="mr-2 d-none d-lg-inline text-gray-600 small"><%=userName%>님</span>
						...
						<div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">회원정보
                                    </h6>
                                </div>
                                    <table class="table">
                                        <tbody><tr>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">센서정보
                                    </h6>
                                </div>
                                    <table class="table">
                                        <!--for 태그로 들어올때마다 추가하기-->
