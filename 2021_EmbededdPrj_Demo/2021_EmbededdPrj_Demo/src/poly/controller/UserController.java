...
public class UserController {
	...
	//----------------------------------------------------임계값 수정 동작을 위한 매핑----------------------------------------------
	@RequestMapping(value="/limitUpdateProc")
	public String limitUpdateProc(HttpServletRequest request, ModelMap model) throws Exception{
		log.info(this.getClass() + "----------------------------------------limit Update Proc start!!-------------");
		String limitValue = CmmUtil.nvl(request.getParameter("limitValue"));
		log.info("limitValue : " + limitValue);
		int res = userService.updLimitValue(limitValue);
		log.info(this.getClass() + "--------------------------------------------limit Update Proc end!!-----------");
		return "/index";
	}
	//----------------------------------------------------임계값 수정 페이지를 위한 매핑----------------------------------------------
	@RequestMapping(value="/limitUpdate")
	public String limitUpdate(HttpServletRequest request, ModelMap model) throws Exception{
		log.info(this.getClass() + "----------------------------------------limit Update start!!-------------");
		log.info(this.getClass() + "--------------------------------------------limit Update end!!-----------");
